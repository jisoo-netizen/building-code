...
PARKING_TABLE: dict[str, int] = {
    ...
    # 별표2 제2호: 100㎡당 1대
    "문화및집회시설":             100,   # 관람장 제외
    "종교시설":                  100,   # 수도원·수녀원·제실·사당 제외(면제)
    "판매시설":                  100,
    "운수시설":                  100,
    "의료시설":                  100,   # 정신병원·요양병원·격리병원 제외
    "운동시설":                  100,   # 골프장·골프연습장·옥외수영장 제외(별도)
    "업무시설_일반":              100,   # 외국공관·오피스텔 제외
    "방송통신시설_방송국":        100,
    "장례식장":                  100,
    ...
    # 별표2 제3호: 134㎡당 1대
    "제1종근린생활시설":          134,   # 3호 바목(변전소 등)·사목(공중화장실 등) 제외
    "제2종근린생활시설":          134,
    "숙박시설":                  134,
    ...
    # 기타
    "관람장":                    0,    # 정원 100인당 1대 (별도 처리)
    "골프연습장":                 0,    # 1타석당 1대 (별도 처리)
    "옥외수영장":                 0,    # 정원 15인당 1대 (별도 처리)
    "그밖의건축물":               200,
}
